...
const svgNewPath =
	'M-446,1199C-446,1199 -843,362.333 -744,297C-645,231.667 -598,-159.333 -499,-216C-400.64,-272.3 4.841,-158.333 158,-246C523.479,-455.196 796.667,-84.333 895,-172C993.333,-259.667 1281.67,35.667 1392,-52C1502.33,-139.667 2054,-52 2054,-52L2054,1206L-446,1199Z'
...
const backArrowSvg = document.querySelector('.btn-arrow svg path')
...
btn.addEventListener('click', () => {
	...
	setTimeout(() => {
		...
		backArrowSvg.setAttribute('fill', '#fff')
	}, 400)
})
...
btnBack.addEventListener('click', () => {
	...
	backArrowSvg.setAttribute('fill', '#000')
